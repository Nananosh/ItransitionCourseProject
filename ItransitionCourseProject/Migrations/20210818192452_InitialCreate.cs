    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CollectionElements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CollectionElements_Collections_CollectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomFieldsTemplates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomFieldsTemplates_Collections_CollectionId",
                        column: x => x.CollectionId,
                        principalTable: "Collections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomFieldsTemplates_CollectionId",
                table: "CustomFieldsTemplates",
                column: "CollectionId");
